# We Build Real — Site manifesto (archival snapshot)

**Archival snapshot** — not the live site copy. Live manifesto text is in `apps/web/src/lib/i18n/dictionaries/` (EN/ES/DE/FR) plus the homepage video. Do not edit this file expecting the site to update.
