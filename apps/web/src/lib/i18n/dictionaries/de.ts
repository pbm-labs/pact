...
export const de: Dictionary = {
  ...
  domain: {
    ...
    awaitingFirst: 'Auf dem Ledger, noch keine Spuren',
    connected: 'Verbunden',
    kindMail: 'Mail',
    kindMailEmpty: 'Keine',
    kindCt: 'Zertifikate',
    ...
    kindLatest: 'Zuletzt',
    mailAuthRate: 'Mail-Auth (DKIM bestanden)',
    certs: 'Zert.',
    sigs: 'Einträge',
    ledgerTitle: 'Ledger',
    ...
    verifiedSince: 'Historie seit',
    awaitingReport: 'Warte auf erste Spur',
