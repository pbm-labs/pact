...
export const btnPrimary =
  'inline-flex items-center justify-center h-11 px-5 rounded-lg bg-accent text-white text-sm font-semibold tracking-wide transition-opacity hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed no-underline';
export const btnPrimaryBlock = `${btnPrimary} w-full`;
export const btnSecondary =
  'inline-flex items-center justify-center h-11 px-5 rounded-lg border border-border bg-bg text-txt text-sm font-semibold hover:border-muted-2 transition-colors no-underline';
...
export const pathCard =
  'flex flex-col items-start gap-2 rounded-lg border border-border bg-surface px-4 py-4 text-left transition-colors hover:border-muted-2 cursor-pointer w-full';
