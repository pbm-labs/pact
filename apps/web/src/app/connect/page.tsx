  ...
  return (
    <PageShell backHref="/domains" backLabel="Records" width="narrow">
      <header className="mb-8">
        ...
        <h1 className={`${pageTitle} mb-2`}>Add a domain</h1>
        <p className={pageIntro}>
          PACT only edits your <code className={inlineCode}>_dmarc</code> TXT record. Reports go to{' '}
          <code className={inlineCode}>{PACT_RUA_ADDRESS}</code> — not your inbox.
        </p>
      </header>
