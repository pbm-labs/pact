    ...
    <main className="flex-1">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <section className="mb-14 sm:mb-16 pt-10 border-t border-border">
          <h2 className={`${sectionTitle} text-xl text-txt mb-4`}>What this never sees</h2>
          <div className={PROSE}>
            <p className="mb-5">
        ...
        <section className="mb-14 sm:mb-16 pt-10 border-t border-border">
          <h2 className={`${sectionTitle} text-xl text-txt mb-4`}>Under the hood</h2>
        ...
        <section className="pt-10 border-t border-border">
          <h2 className={`${sectionTitle} text-xl text-txt mb-4`}>What happens next</h2>
          <div className={PROSE}>
            <p className="mb-5">
