  ...
  return (
    <div className="max-w-2xl">
      <header className="mb-10">
        ...
        <p className="text-xs font-mono text-muted-2 m-0">
          Last updated {LEGAL_ENTITY.lastUpdated}
        </p>
      </header>
      ...
      <section className="mb-10 text-sm text-muted leading-relaxed">
        ...
        <p className="mt-3 m-0">
          Email:{' '}
          <a href={`mailto:${LEGAL_ENTITY.email}`} className="text-accent font-semibold no-underline">
            {LEGAL_ENTITY.email}
          </a>
        </p>
        {children}
